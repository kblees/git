 ...
 * compare_function: function to test equality of hashmap entries
 * initial_size: number of initial entries, or 0 if unknown
 */
extern void hashmap_init(hashmap *map, hashmap_cmp_fn compare_function,
		size_t initial_size);
...
static inline hashmap_entry *hashmap_iter_first(hashmap *map, hashmap_iter *iter)
{
